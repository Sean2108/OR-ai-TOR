...
export default class AllTimeFeedback extends Component {
  render() {
    
    const fill = 'rgb(134, 65, 244)'
    const barData   = [ 50, 10, 40, 95, 4, 12, 85, 160, 35, 53 ]
          ...
          <Card>
            <CardItem>
              <Left>
                ...
                <Body>
                  <Text>Frequency of your overall top 10 stop-words</Text>
          ...
          <Card>
            <CardItem>
              <Left>
                ...
                <Body>
                  <Text>Overall Pitch Intonation</Text>
          ...
          <Card>
            <CardItem>
              <Left>
                ...
                <Body>
                  <Text>Comparison of your overall top 10 stop-words</Text>
                </Body>
              </Left>
            </CardItem>
            <View>
